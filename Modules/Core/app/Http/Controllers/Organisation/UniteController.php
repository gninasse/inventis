...
namespace Modules\Core\Http\Controllers\Organisation;
...
use Modules\Core\Models\Organisation\Direction;
use Modules\Core\Models\Organisation\Service;
use Modules\Core\Models\Organisation\Site;
use Modules\Core\Models\Organisation\Unite;
...
class UniteController extends Controller implements HasMiddleware
{
    ...
    public function index()
    {
        ...
        return view('core::organisation.unites.index', compact('sites'));
    }
