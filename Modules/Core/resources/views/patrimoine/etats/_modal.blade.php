<div class="modal fade" id="createEtatModal" tabindex="-1" aria-labelledby="createEtatModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createEtatModalLabel">Nouvel État</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="etatForm">
                @csrf
                <input type="hidden" id="etat_id" name="id">
                <div class="modal-body">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="declencheur_reforme" name="declencheur_reforme">
                        <label class="form-check-label" for="declencheur_reforme">Suggérer Réforme (État critique)</label>
                    </div>
