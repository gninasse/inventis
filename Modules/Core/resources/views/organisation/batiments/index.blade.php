    ...
    $('#btn-toggle-status').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: route('cores.organisation.batiments.toggle-status', id),
                    type: 'PATCH',
                    headers: {
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="batiments-table"
               data-toggle="table"
               data-url="{{ route('cores.organisation.batiments.data') }}"
...
@include('core::organisation.batiments._modal')
@stop
...
<script>
    window.batimentRoutes = {
        data: "{{ route('cores.organisation.batiments.data') }}"
    };
...
<script type="module" src="{{ asset('js/modules/core/batiments/index.js') }}"></script>
@endpush
