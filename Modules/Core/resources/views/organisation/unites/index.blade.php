...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="unites-table"
               data-toggle="table"
               data-url="{{ route('cores.organisation.unites.data') }}"
...
@include('core::organisation.unites._modal')
@stop
...
<script>
    window.uniteRoutes = {
        ...
        servicesByDirection: "{{ route('cores.organisation.unites.services-by-direction', ['directionId' => ':directionId']) }}",
        majors: "{{ route('cores.organisation.unites.majors') }}",
        data: "{{ route('cores.organisation.unites.data') }}"
    };
...
<script type="module" src="{{ asset('js/modules/core/unites/index.js') }}"></script>
@endpush
