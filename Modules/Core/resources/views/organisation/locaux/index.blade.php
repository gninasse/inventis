    ...
    $('#btn-toggle-status').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: route('cores.organisation.locaux.toggle-status', id),
                    type: 'PATCH',
                    headers: {
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="locaux-table"
               data-toggle="table"
               data-url="{{ route('cores.organisation.locaux.data') }}"
...
@include('core::organisation.locaux._modal')
@stop
...
<script>
    window.localRoutes = {
        batimentsBySite: "{{ route('cores.organisation.batiments.by-site', ['siteId' => ':siteId']) }}",
        etagesByBatiment: "{{ route('cores.organisation.etages.by-batiment', ['batimentId' => ':batimentId']) }}",
        data: "{{ route('cores.organisation.locaux.data') }}"
    };
...
<script type="module" src="{{ asset('js/modules/core/locaux/index.js') }}"></script>
@endpush
