    ...
    $('#btn-toggle-status').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: route('cores.organisation.etages.toggle-status', id),
                    type: 'PATCH',
                    headers: {
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="etages-table"
               data-toggle="table"
               data-url="{{ route('cores.organisation.etages.data') }}"
...
@include('core::organisation.etages._modal')
@stop
...
<script>
    window.etageRoutes = {
        ...
        data: "{{ route('cores.organisation.etages.data') }}"
    };
...
<script type="module" src="{{ asset('js/modules/core/etages/index.js') }}"></script>
@endpush
