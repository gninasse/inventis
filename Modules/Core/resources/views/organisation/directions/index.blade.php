...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="directions-table"
               data-toggle="table"
               data-url="{{ route('cores.organisation.directions.data') }}"
...
@include('core::organisation.directions._modal')
@stop
...
<script type="module" src="{{ asset('js/modules/core/directions/index.js') }}"></script>
@endpush
