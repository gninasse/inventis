...
return [
    ...
    // Sites
    'cores.organisation.sites.index' => 'Voir la liste des sites',
    ...
    // Statuts
    'cores.patrimoine.statuts.index' => 'Voir la liste des statuts des biens',
    'cores.patrimoine.statuts.store' => 'Créer un statut de bien',
    'cores.patrimoine.statuts.update' => 'Modifier un statut de bien',
    'cores.patrimoine.statuts.destroy' => 'Supprimer un statut de bien',

    // États
    'cores.patrimoine.etats.index' => 'Voir la liste des états des biens',
    'cores.patrimoine.etats.store' => 'Créer un état de bien',
    'cores.patrimoine.etats.update' => 'Modifier un état de bien',
    'cores.patrimoine.etats.destroy' => 'Supprimer un état de bien',
];
