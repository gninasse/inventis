/**
 * index.js
 * Entry point for Fournisseurs management
 */
...
$(function () {
    ...
    const fournisseurForm = new FournisseurForm('#modal', '#fournisseurForm', tableInstance);
    new FournisseurActions(tableInstance, fournisseurForm);
